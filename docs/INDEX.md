...
Use this index to quickly navigate to specific documentation areas.
...
### Architecture
**[architecture/INDEX.md](architecture/INDEX.md)** - Complete architecture documentation

Quick links:
- [OVERVIEW.md](architecture/OVERVIEW.md) - System architecture overview
- [TASK_SYSTEM_DESIGN.md](architecture/TASK_SYSTEM_DESIGN.md) - Task tracking system
- [CONTEXT_OPTIMIZATION_REPORT.md](architecture/CONTEXT_OPTIMIZATION_REPORT.md) - Optimization analysis
...
### Archives
**[archives/INDEX.md](archives/INDEX.md)** - Historical and deprecated documentation
